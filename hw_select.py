...
from certificate_interval import Student, Grade, Subject, Teacher, Group
...
def select_10():
    ...
    print('Select 10:')
    student_name = "Yas'ko Stanislav"
    teacher_name = 'Kysyl Oksana'
...
def select_11():
    ...
    print('\nSelect 11')
    teacher_name = 'Chernysh Svytlana'
    student_name = 'Komm Melissa'
...
def select_12():
    ...
    print('\nSelect 12')
    group_name = 'KS-23-2/11'
    subject_name = 'Teoriya elektromagnitnych kil'
